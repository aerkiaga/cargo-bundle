...
fn create_control_table(package: &mut Package, _cabinets: &[CabinetInfo]) -> crate::Result<()> {
    ...
    let actions: [ControlTableEntry; 43] = [
        ...
        ("WelcomeDialog", "WelcomeBitmap", "Bitmap", 0, 0, 100, 234, 1, "", "dialog.png", "WelcomeBack", ""),
        ...
        ("RemoveDialog", "RemoveBitmap", "Bitmap", 0, 0, 100, 234, 1, "", "dialog.png", "RemoveBack", ""),
        ...
        ("ExitDialog", "ExitBitmap", "Bitmap", 0, 0, 100, 234, 1, "", "dialog.png", "ExitBack", ""),
        ...
        ("FatalErrorDialog", "FatalBitmap", "Bitmap", 0, 0, 100, 234, 1, "", "dialog.png", "FatalBack", ""),
